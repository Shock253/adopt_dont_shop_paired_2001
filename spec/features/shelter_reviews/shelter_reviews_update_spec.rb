...
RSpec.describe "Shelter reviews edit page" do
  ...
  it "can not update shelter review without correct values" do
    shelter_1 = Shelter.create!(name: "Denver Animal Shelter",
                               address: "500 Invisible St.",
                               city: "Denver",
                               state: "Colorado",
    ...
    click_button('Update Shelter Review')
    expect(page).to have_content("Update not recorded: Please enter title, rating, and content to edit review.")
